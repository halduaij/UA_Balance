...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_12"]["modifier"]["value"] = 0
...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_14"]["modifier"] = Reference([[modifiers\max_squad_cap_player_modifier.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_14"]["modifier"]["shield_of_faith"] = false
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_14"]["modifier"]["value"] = 6
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_15"] = Reference([[tables\time_modify_entry.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_15"]["modifier"] = Reference([[modifiers\max_support_cap_player_modifier.lua]])
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_15"]["modifier"]["shield_of_faith"] = false
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_15"]["modifier"]["value"] = 1
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16003791]] -- - Special infinite-range targetable ability that sacrifices an army Commander, in exchange for greater army size!
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16003792]] -- - The targeted Commander loses control of its body and cannot act, as daemonic chains engulf it.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16003793]] -- - The daemonic chains eventually firm their painful grip, leaving only blood and bones.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16003794]] -- - This sacrifice to the Chaos Gods, temporarily rises the maximum Daemon Army caps to 30/5.
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16003795]] -- - The duration of the effect ends, with the eventual inevitable death of the Commander.
GameData["ui_info"]["help_text_list"]["text_06"] = [[$16003796]] -- - Left-click and target an allied Commander to activate.
GameData["ui_info"]["icon_name"] = [[daemons_icons/daemons_ability_sacrifice_icon]]
GameData["ui_info"]["screen_name_id"] = [[$16003790]] -- Vile Sacrifice
GameData["ui_instructional_msg"] = [[$16003798]] -- Left-click on an army Commander, to be sacrificed and grant your Daemons Army immense potential!
GameData["ui_invalid_target_msg"] = [[$16003799]] -- Sacrifice can only target your own Commanders!
