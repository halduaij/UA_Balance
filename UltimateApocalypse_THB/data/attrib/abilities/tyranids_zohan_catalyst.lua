...
GameData["ui_hotkey_name"] = [[tyranids_zohan_catalyst]]
...
GameData["ui_info"]["help_text_list"]["text_02"] = [[$4100098]] -- - Left-click and target an allied infantry squad to activate.
GameData["ui_info"]["icon_name"] = [[Tyranids_icons/i_catalyst_square]]
