...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16028513]] -- - Trigger the intervention of a lurking Skulker, to attempt sabotage of an enemy vehicle.
GameData["ui_info"]["help_text_list"]["text_02"] = [[$16028514]] -- - Target vehicle's crew faces an ambush within the hull.
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16028515]] -- - May cause movement and/or combat impairments, loss of control, heavy damage or no effect at all.
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16028516]] -- - Left-click and target an enemy vehicle to activate.
GameData["ui_info"]["icon_name"] = [[tyranids_icons/i_skulker]]
GameData["ui_info"]["screen_name_id"] = [[$16028512]] -- "What the...??"
GameData["ui_instructional_msg"] = [[$16028516]] -- - Left-click and target an enemy vehicle to activate.
