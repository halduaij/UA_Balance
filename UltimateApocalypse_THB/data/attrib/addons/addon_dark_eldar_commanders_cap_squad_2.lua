...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_dark_eldar_commanders_cap_squad.lua]]
...
GameData["requirements"]["required_11"]["addon_name"] = [[addons\addon_dark_eldar_commanders_cap_squad.lua]]
