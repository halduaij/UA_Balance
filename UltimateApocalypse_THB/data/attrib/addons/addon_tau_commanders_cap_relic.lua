...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\addon_tau_commanders_cap_squad.lua]]
...
GameData["requirements"]["required_12"]["research_name"] = [[research\tau_relic_research_2.lua]]
