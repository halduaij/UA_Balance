...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\addon_marine_commanders_cap_squad.lua]]
...
GameData["requirements"]["required_12"]["research_name"] = [[research\marine_relic_research_2.lua]]
