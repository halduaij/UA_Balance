...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\chaos_turret_addon_probe.lua]]
...
GameData["requirements"]["required_7"]["addon_name"] = [[addons\chaos_turret_addon_probe.lua]]
