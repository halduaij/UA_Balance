...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\addon_dark_eldar_commanders_cap_relic.lua]]
...
GameData["requirements"]["required_7"]["mutually_exclusive_with"] = [[addons\addon_dark_eldar_commanders_increase_production.lua]]
GameData["requirements"]["required_8"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_8"]["mutually_exclusive_with"] = [[addons\addon_dark_eldar_commanders_increase_health.lua]]
GameData["requirements"]["required_9"] = Reference([[requirements\required_addon_cap.lua]])
GameData["requirements"]["required_9"]["addon"] = [[addon_dark_eldar_commanders_increase_morale]]
