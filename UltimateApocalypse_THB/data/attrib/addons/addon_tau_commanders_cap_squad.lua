...
GameData["requirements"]["required_1"]["mutually_exclusive_with"] = [[addons\addon_tau_commanders_cap_support.lua]]
GameData["requirements"]["required_2"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_2"]["mutually_exclusive_with"] = [[addons\addon_tau_commanders_cap_relic.lua]]
GameData["requirements"]["required_6"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_6"]["mutually_exclusive_with"] = [[addons\addon_tau_commanders_increase_production.lua]]
