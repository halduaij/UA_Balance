...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_sisters_commanders_increase_production.lua]]
...
GameData["requirements"]["required_11"]["addon_name"] = [[addons\addon_sisters_commanders_increase_production.lua]]
