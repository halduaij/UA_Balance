...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_dark_eldar_commanders_increase_production.lua]]
...
GameData["requirements"]["required_11"]["addon_name"] = [[addons\addon_dark_eldar_commanders_increase_production.lua]]
