...
GameData["requirements"]["required_1"]["addon_name"] = [[addons\addon_tyranids_commanders_cap_support.lua]]
...
GameData["requirements"]["required_11"]["addon_name"] = [[addons\addon_tyranids_commanders_cap_support.lua]]
