...
GameData["requirements"]["required_1"]["mutually_exclusive_with"] = [[addons\addon_sisters_commanders_cap_support.lua]]
...
GameData["requirements"]["required_3"]["mutually_exclusive_with"] = [[addons\addon_sisters_commanders_cap_faith.lua]]
