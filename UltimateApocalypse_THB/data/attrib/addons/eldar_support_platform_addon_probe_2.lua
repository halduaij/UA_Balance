...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\eldar_support_platform_addon_probe.lua]]
...
GameData["requirements"]["required_7"]["addon_name"] = [[addons\eldar_support_platform_addon_probe.lua]]
