...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\addon_eldar_commanders_cap_squad.lua]]
GameData["requirements"]["required_5"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_5"]["mutually_exclusive_with"] = [[addons\addon_eldar_commanders_cap_support.lua]]
GameData["requirements"]["required_6"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_6"]["mutually_exclusive_with"] = [[addons\addon_eldar_commanders_increase_production.lua]]
GameData["requirements"]["required_7"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_7"]["mutually_exclusive_with"] = [[addons\addon_eldar_commanders_increase_health.lua]]
GameData["requirements"]["required_8"] = Reference([[requirements\local_required_addon_exclusive.lua]])
GameData["requirements"]["required_8"]["mutually_exclusive_with"] = [[addons\addon_eldar_commanders_increase_morale.lua]]
...
GameData["requirements"]["required_11"]["research_name"] = [[research\eldar_commander_level1_research.lua]]
...
GameData["requirements"]["required_12"]["research_name"] = [[research\eldar_relic_research_2.lua]]
