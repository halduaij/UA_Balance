...
GameData["modifiers"]["modifier_01"] = Reference([[modifiers\health_maximum_player_modifier.lua]])
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[$16022308]] -- - Applies a global bonus to health (5%), morale (5%), support cap increase (+5), squad cap increase (+5), and relic income increase (200/+10).
...
GameData["ui_info"]["help_text_list"]["text_03"] = [[$16022310]] -- - Unlocks the Abilities : Psychic Recovery, Fireball, Word of the Emperor, Doom, Inspiration Conquest
