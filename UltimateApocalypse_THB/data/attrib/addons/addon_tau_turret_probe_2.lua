...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\addon_tau_turret_probe.lua]]
...
GameData["requirements"]["required_7"]["addon_name"] = [[addons\addon_tau_turret_probe.lua]]
