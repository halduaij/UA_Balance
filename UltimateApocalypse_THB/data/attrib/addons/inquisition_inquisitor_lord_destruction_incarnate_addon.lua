...
GameData["ui_info"]["help_text_list"]["text_04"] = [[$16022306]] -- - Applies a global bonus to damage (5%), support cap increase (+5), squad cap increase (+5), and relic income increase (200/+10).
GameData["ui_info"]["help_text_list"]["text_05"] = [[$16022311]] -- - Unlocks the Abilities : Slow, Mightest Swing, Doom of the Machine Spirit, Emperors Wrath, Dark Commandment
GameData["ui_info"]["help_text_list"]["text_06"] = [[$18210588]] -- - Requires - Hero: Level 2
