...
GameData["requirements"]["required_4"]["mutually_exclusive_with"] = [[addons\addon_inquisition_commanders_cap_squad.lua]]
...
GameData["requirements"]["required_12"]["research_name"] = [[research\inquisition_increase_relic_2.lua]]
