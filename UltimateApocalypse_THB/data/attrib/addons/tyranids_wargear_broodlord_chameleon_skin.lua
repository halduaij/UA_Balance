...
GameData["requirements"]["required_2"]["addon_name"] = [[addons\tyranids_wargear_broodlord_impaler.lua]]
GameData["requirements"]["required_3"] = Reference([[requirements\local_required_addon.lua]])
GameData["requirements"]["required_3"]["addon_name"] = [[addons\tyranids_wargear_broodlord_impaler.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The skin is ever shifting, adapting to texture and colour of its surroundings.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Grants 10% ranged resistance]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- Also infiltrates the broodlord as long as he hasn't taken any damage.]]
...
GameData["ui_info"]["screen_name_id"] = [[Chameleon Skin]]
