...
GameData["entity_blueprint_ext"]["animator"] = [[Races/Tyranids/Projectiles/spore_bioacid]]
...
GameData["projectile_ext"]["death_event_name"] = [[Ground_Impact/tyranids_impact_spores_bioacid]]
