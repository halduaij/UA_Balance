...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000163]] -- - Durability: 3 | Strength: 3.5 | Morale: 3.5 | Upgrades: 0 | Squad Size: Standard | Movement Speed: Standard | Sight: Standard | Sight: 2m | Ability Strength: 3 | Weapon range: 0 | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000164]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000165]] -- 
