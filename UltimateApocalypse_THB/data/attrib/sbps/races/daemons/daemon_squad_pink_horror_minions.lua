...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["max_cumulative_squad_cap"] = 3
GameData["squad_requirement_ext"]["requirements"]["required_3"]["squad_table"]["squad_01"] = [[sbps\races\daemons\daemon_squad_pink_horror.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000187]] -- - Durability: 3 | Strength: 4.5 | Morale: 3.5 | Upgrades: 1 | Squad Size: Below standard | Movement Speed: Standard | Sight: Standard | Keen Sight: 2m | Ability Strength: 0 | Weapon range: Standard | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000188]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000189]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000190]] -- 
