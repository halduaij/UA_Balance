...
GameData["squad_requirement_ext"]["requirements"]["required_3"]["squad_table"]["squad_01"] = [[sbps\races\daemons\daemon_squad_bloodthirster.lua]]
...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_01"] = [[$16000239]] -- - Durability: 12 | Strength: 12 | Morale: Immune | Upgrades: 0 | Squad Size: Single | Movement Speed: Standard | Sight: Good | Keen Sight: None | Ability Strength: 1 | Weapon range: 0 | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000240]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000241]] -- Greater Brass Scorpion
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000242]] -- - Titanic Daemon Engine. ~~~ Unleashes a great warp rift upon death; is very effective at either ranged (artillery purposes) or melee combat.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000276]] -- 
GameData["squad_ui_ext"]["ui_info"]["icon_name"] = [[daemons_icons/daemons_bloodthirster_icon]]
GameData["squad_ui_ext"]["ui_info"]["screen_name_id"] = [[$16000238]] -- - Greater Daemon Engine. ~~~ Unleashes a great warp rift upon death.
