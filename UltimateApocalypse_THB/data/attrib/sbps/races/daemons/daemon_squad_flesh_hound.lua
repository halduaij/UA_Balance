...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000199]] -- - Durability: 2 | Strength: 3.5 | Morale: 3.5 | Upgrades: 0 | Squad Size: Standard | Movement Speed: Very Fast | Sight: Good | Keen Sight: 2m | Ability Strength: 1 | Weapon range: 0 | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000200]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000201]] -- 
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_05"] = [[$16000202]] -- 
