...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = [[$16000169]] -- - Durability: 3 | Strength: 4 | Morale: 3.5 | Upgrades: 0 | Squad Size: Below standard | Movement Speed: Fast | Sight: Standard | Keen Sight: 2m | Ability Strength: 1 | Weapon range: 0 | Capture Points: No.
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_03"] = [[$16000170]] -- - Can be killed very easily if not under the possession of the warp (depleted morale).
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_04"] = [[$16000171]] -- 
