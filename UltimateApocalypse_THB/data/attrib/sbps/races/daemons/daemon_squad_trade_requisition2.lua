...
GameData["squad_loadout_ext"]["birth_resource"]["requisition"] = 250
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\daemons_requisition_research_1.lua]]
