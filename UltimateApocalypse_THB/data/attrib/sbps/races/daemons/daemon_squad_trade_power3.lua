...
GameData["squad_loadout_ext"]["birth_resource"]["power"] = 400
...
GameData["squad_requirement_ext"]["requirements"]["required_1"]["research_name"] = [[research\daemons_power_research_2.lua]]
