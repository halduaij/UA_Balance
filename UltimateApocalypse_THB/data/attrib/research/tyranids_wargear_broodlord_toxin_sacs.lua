...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- This parasite provides its host with a deadly cocktail of toxins to the boundless anguish of its prey.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Allow to poison enemy with each melee attack]]
...
GameData["ui_info"]["screen_name_id"] = [[Toxin Sacs]]
