...
GameData["requirements"]["required_2"]["research_name"] = [[research\tyranids_commander_level1_research.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- The Broodlord projects a veil of dread into his vicinity, robbing enemies of their will to fight.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- Nearby enemies will not regenerate morale for a good duration]]
...
GameData["ui_info"]["icon_name"] = [[tyranids_icons/broodlord_miasma_of_despair]]
...
GameData["ui_info"]["screen_name_id"] = [[Aura of Despair]]
