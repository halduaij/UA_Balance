...
GameData["requirements"]["required_3"]["mutually_exclusive_with"] = [[addons\tyranids_wargear_broodlord_impaler.lua]]
...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Genestealers were initially thought to be inhabitants of the moons of Ymgarl.]]
GameData["ui_info"]["help_text_list"]["text_02"] = [[- That notion died when they were seen figthing among the tyranid hordes.]]
GameData["ui_info"]["help_text_list"]["text_03"] = [[- The genestealers of Ymgarl are known for their rapid adabtability, changing their physique at a moments notice.]]
GameData["ui_info"]["help_text_list"]["text_04"] = [[- The Broolord is provided with the following buffs when it is in a pinch (less than 30% health):]]
GameData["ui_info"]["help_text_list"]["text_05"] = [[- Ranged damage mitigation +50%]]
GameData["ui_info"]["help_text_list"]["text_06"] = [[- Damage dealt +40%]]
GameData["ui_info"]["help_text_list"]["text_07"] = [[- Movement speed +40%]]
GameData["ui_info"]["help_text_list"]["text_08"] = [[- WARNING: Incompatible with the Impaler mutation]]
GameData["ui_info"]["icon_name"] = [[tyranids_icons/broodlord_the_ymgarl_factor]]
...
GameData["ui_info"]["screen_name_id"] = [[The Ymgarl Factor]]
