...
GameData["ui_info"]["help_text_list"]["text_01"] = [[- Broodlords often develop acute senses that leaves their prey little ability to hide]]
...
GameData["ui_info"]["screen_name_id"] = [[Sharp Senses]]
